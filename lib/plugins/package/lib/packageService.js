...
module.exports = {
  ...
  packageService() {
    ...
    if (this.serverless.service.package.individually) {
      ...
      var packageAllPromises = _.map(dummyArray, functionName =>
        this.packageAll());
      packagePromises.push(packageAllPromises[0]);
  ...
  packageAll() {
    ...
    this.serverless.cli.log('Packaging all services...' + zipFileName);
